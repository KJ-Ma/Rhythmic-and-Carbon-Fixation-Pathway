...
otutable <- read.table("final_rhythmic_ASV.txt", sep = "\t", header = TRUE, check.names = FALSE, comment.char = "", row.names = 1)

# Load metadata and environmental data
fastmap <- read.table("metadata.txt", sep = "\t", header = TRUE, check.names = FALSE, comment.char = "", row.names = 1)
env <- read.table("../env.txt", sep = "\t", header = TRUE, check.names = FALSE, comment.char = "", row.names = 1)
